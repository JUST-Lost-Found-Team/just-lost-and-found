          ...
          key: _formKey,
           child: Column(
            children: [
              ...
              Image.asset('images/password_image.png',height: 200,fit: BoxFit.cover,),
              const Text(
                'Forget Password?',
                style:TextStyle(
                ...
                child:Text.rich(
                  TextSpan(
                    children:[
                      ...
                      TextSpan(
                        text: 'JUST email',
                        style: TextStyle(color: Color(0xFFE4973F), fontWeight: FontWeight.w600),
                      ),
                      const TextSpan(text: '. Check your inbox for a password reset link.'),
                    ] ,),
               ...
               style: TextStyle(
                ...
                SizedBox(
                  ...
                  (onPressed: () async {
                    ...
                    await AuthServices.resetPassword(emailCTRL.text.trim());
                    setState(() {
                      loader=false;
                    });
