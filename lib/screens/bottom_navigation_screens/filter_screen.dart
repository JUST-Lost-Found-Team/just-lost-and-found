...
class _FilterScreenState extends State<FilterScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Filter by Location",style: TextStyle(color:Colors.white),),
              ...
              child: Row(
                children: [
                  Expanded(child: OutlinedButton(
                    ...
                    child: const Text('reset',style: TextStyle(color: ThemeManager.primaryBlue),),
                  ),),
 ...
 Widget _buildExpansionSection(String title, IconData icon, List<String> items) {
